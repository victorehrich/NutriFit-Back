...
using NutriFit.Domain.Validations.Interfaces;
using System;
...
namespace NutriFit.Domain.Validations
{
    internal class UserValidations : IValidate
    {
        ...
        public UserValidations EmailValidation()
        {
            ...
            var isValid = Regex.IsMatch(_user.Email, regex, RegexOptions.IgnoreCase);
            if (!isValid)
            {
                _user.PullNotification(new Notification("Email", "Email Inválido"));
            }
            return this;
        }
